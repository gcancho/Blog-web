    ...
    <section class="footer-1">
        <div class="wrap">
            ...
            <article class="item-footer-2">
                ...
                <a href="about-me.php"><label>About me</label></a>
                <a href="nature.php"><label>Nature</label></a>
                <a href="food.php"><label>Food & Health</label></a>
                <a href="lifestyle.php"><label>Lifestyle</label></a>
                <a href="contact.php"><label>Contact</label></a>
            </article>
            <article class="item-footer-2">
